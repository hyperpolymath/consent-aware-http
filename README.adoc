...
:license-PMPL--1.0: Dual: PMPL-1.0 + PMPL-1.0 4.0 (Palimpsest-0.8 encouraged)
:reproducible:
...
|**PMPL-1.0-or-later** +
(Copyleft)
|Code, specifications (alternative to PMPL-1.0)
|`PMPL-1.0-or-later`
...
====
We **philosophically encourage** dual-licensing under the **Palimpsest License v0.8** alongside PMPL-1.0 or PMPL-1.0+.
...
* link:LICENSE.txt[LICENSE.txt] - Primary license (PMPL-1.0)
* link:LICENSE-PMPL-1.0.txt[LICENSE-PMPL-1.0.txt] - PMPL-1.0 full text
* link:LICENSE-PMPL-1.0.txt[LICENSE-PMPL-1.0.txt] - PMPL-1.0 full text
* link:LICENSE-PALIMPSEST.txt[LICENSE-PALIMPSEST.txt] - Palimpsest v0.8
* link:LICENSE-PMPL-1.0-4.0.txt[LICENSE-PMPL-1.0-4.0.txt] - Creative Commons (docs)
...
**License**: PMPL-1.0 OR PMPL-1.0-or-later + PMPL-1.0 4.0 (Palimpsest encouraged) +
**Version**: 0.2.0 +
