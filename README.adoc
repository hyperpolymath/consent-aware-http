...
:experimental:
:url-github: https://github.com/hyperpolymath/consent-aware-http
:url-gitlab: https://gitlab.com/hyperpolymath/consent-aware-http
:url-bitbucket: https://bitbucket.org/hyperpolymath/consent-aware-http
:url-codeberg: https://codeberg.org/hyperpolymath/consent-aware-http

HTTP client library with GDPR consent management
...
consent-aware-http is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
